        ...
        init: function () {
            ...
            var oTable = $('#sample_editable_1').dataTable({
                ...
                "fnServerData" : function(sSource, aoData, fnCallback) {
                	Server.getVideos(aoData).onSuccess(function(videoList){
                ...
                "aoColumns":[
                			 ...
                			 { "mData": "V_Progress",
                				 "fnRender": function (obj) {
                                     return obj.aData.V_Progress+' %';
                                 }},
                			 { "fnRender": function (obj) {
                                 return '<a class="delete" href="javascript:;" value="'+obj.aData.U_ID+'">重试</a>';
                             }},
                             { "fnRender": function (obj) {
                                 return '<a class="delete" href="javascript:;" value="'+obj.aData.U_ID+'">停止</a>';
                             }},
                             { "fnRender": function (obj) {
                                 return '<a class="delete" href="javascript:;" value="'+obj.aData.U_ID+'">删除</a>';
                             }}
                ]
            });
